...
class EmoActCvae(nn.Module):
    ...
    def forward(self, batch):
        ...
        # dec_batch：torch.Size([batch_size, length]) append eos
        dec_batch = batch['target_batch']
        dec_ext_batch = batch["target_ext_batch"]

        # update knowledge sequence and key knowledge in dialogue
        ...
        act_encoder_outputs_new = act_encoder_outputs
        ...
        return act_encoder_outputs_new, enc_batch, dec_batch, enc_batch_extend_vocab, extra_zeros, dec_ext_batch, mask_src, mask_s, mask_l, s_encoder_outputs, l_encoder_outputs, r_encoder_outputs, act_encoder_outputs, k_scores
    ...
    def train_one_batch(self, batch, iter, train = True):
        ...
        act_encoder_outputs_new, enc_batch, dec_batch, enc_batch_extend_vocab, extra_zeros, dec_ext_batch, \
        ...
        # (batch, len) #remove eos，append sos in the begining
        ...
        elbo = loss_rec + weighted_kld_loss  # maxmimum elbo
        loss = loss_rec + weighted_kld_loss + 0.1*loss_aux + 0.1*emotion_l_loss + 0.03*emotion_s_loss + 0.05*act_loss
